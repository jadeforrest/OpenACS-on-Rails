class LangMessagesAudit < ActiveRecord::Base
  ...
  validates_presence_of :overwrite_date
  validates_numericality_of :overwrite_user, :allow_nil => true, :only_integer => true
